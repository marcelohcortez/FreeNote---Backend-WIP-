...
const getClientsNamesAndIds = async (req: Request, res: Response) => {
  try {
...
const createClient = async (req: Request, res: Response) => {
  ...
  const requiredFields: (keyof ClientType)[] = [
    "name",
    "email",
    "phone",
    "country",
  ...
  const emptyFields: (keyof ClientType)[] = requiredFields.filter(
    (field) => !client[field]
  );
